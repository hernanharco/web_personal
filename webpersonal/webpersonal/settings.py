...
SECRET_KEY = 'django-insecure-g+6ju-!g+@&8(^3sp)vllax2tby5ih(&4r&fk@#8u37k_0nen)'
...
INSTALLED_APPS = [
    ...
    'core',
    'portfolio.apps.PortfolioConfig',  # Cambia 'portfolio' por 'portfolio.apps.PortfolioConfig'
]
